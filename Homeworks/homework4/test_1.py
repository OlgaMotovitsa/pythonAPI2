...
with open(r"C:\Users\Оля\PycharmProjects\pythonAPI2\Homeworks\homework4\testdata.yaml") as f:
    testdata = yaml.safe_load(f)

with open(r'C:\Users\Оля\PycharmProjects\pythonAPI2\Homeworks\homework4\config.yaml') as f:
...
def test_step3(browser):
    ...
    testpage.enter_title_post("HW4")
    testpage.enter_content_post("The best")
    testpage.click_create_nwe_post_button()

    time.sleep(3)

    # Проверка наличия названия поста на странице
    assert testpage.post() == "HW4"
