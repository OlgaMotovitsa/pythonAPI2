...
with open(r"C:\Users\Оля\PycharmProjects\pythonAPI2\Homeworks\homework3\testdata.yaml") as f:
...
def test_step3(browser):
    ...
    testpage.enter_title_post("Homework3")
    testpage.enter_content_post("The best Lesson")
    testpage.click_create_nwe_post_button()

    time.sleep(3)

    # Проверка наличия названия поста на странице
    assert testpage.post() == "Homework3"
...
def test_step5(browser):
    ...
    testpage.enter_name("some name")
    testpage.enter_email("some@email.ru")
    testpage.enter_content_to_form("message")
    testpage.click_contact_us_button()

    time.sleep(3)

    # Проверка надписи - Form successfully submitted (alert)
